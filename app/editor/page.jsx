                    ...
                    if (data.imageURL) {
                      ...
                      currentEditor.chain().insertContentAt(pos, {
                        ...
                        //   src: `https://dccvcdil526gz.cloudfront.net/${data.imageURL}`,  // Use the uploaded image URL from the response
                          src: `https://dccvcdil526gz.cloudfront.net/bae1d822-f685-40de-bf0a-870b6f6609f3-action1.webp`,  // Use the uploaded image URL from the response
                        },
                      }).focus().run();
                    }
                  })
...
// file 2
            ...
            editorProps: {
                attributes: {
                  class: 'p-4 prose prose-sm sm:prose-base lg:prose-lg xl:prose-2xl  focus:outline-none outline-none border border-blue-600 bg-white text-black min-h-[250px]',
                },
    ...
    return (
        ...
        <div className=' p-4 border border-yellow-100'>  
            ...
            <button onClick={handleSubmit} className="mt-4 px-4 py-2 bg-blue-800 hover:bg-zinc-500 text-white rounded">Done</button>
